...
import edu.kh.jdbc.board.modle.dto.Board;
import edu.kh.jdbc.board.modle.dto.Comment;
...
//	            case 4:   searchBoard(); break; // 게시글 검색
	...
	private void insertBoard() {
		...
		try {
			// 게시글 삽입 서비스 호출
		    int result = boardService.insetBoard(boardTitle,content.toString(),Session.loginMember.getMemberNo());
