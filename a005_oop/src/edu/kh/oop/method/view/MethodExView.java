...
public class MethodExView {
   //필드(==멤버변수)
	...
	private void menu3() {
		...
		// 1) service 의 fiveRandomNumbers()를 호출
	...
	private void menu4() {
		...
		//정수 2개 , 연산자를 입력 받아 게산 서비스 호출 후
		//연산 결과를 반환 받아서 출력
		System.out.println("*** menu4() 실행 ***");
		System.out.println("[입력된 정수 2개, 연산자를 이용해서 게산하기]");
		...
		//service 의 calculate() 메서드 호출 시 매겨변수 3개를 전달
