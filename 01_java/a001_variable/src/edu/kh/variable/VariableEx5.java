...
public class VariableEx5 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 형변환(Casting) : 값의 자료'형'을 '변환'하는 것
		 * 
		 * 형변환은 왜 필요한가? -> 컴퓨터의 값 처리 원칙을 위배하는 경우를 해결하기 위해 필요 (같은 자료형끼리 연산, 결과도 같은 자료형)
		 * 
		 * [자동 형변환] 
