...
/*@WebServlet 어노테이션
 * 	- 어노테이션 ( Annotaition) : 컴파일러가 읽는 주석(설명)
...
public class ExampleController2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// HttpServletRequest : 요청 데이터를 담고있는 객
		...
		out.println("<head> <title>"+orderer+"의 주문 결과 </title> </head>");
		...
		//	  전달 된 값 중 name이 일치하는 값이 없으면
		//	  null 반환
		if(optionArr != null) {
			
			out.println("<h3>옵션</h3>");
