...
//		else {res="BLUE";}
		...
		//2번 switch 버전 input이 한가지 경우의 수 일 경우만 가능
		switch(input){
...
//		Math.random() : 난수 발생
	...
	public void ex3() {
		...
		if(price != -1) {
			System.out.printf("%s = %d원 입니다.",input , price);
		}else {//price가 -1 인 경우
       ...
       //switch 예시 4번
         ...
         System.out.print("연산자 입력 : ");
            ...
            int Num1 = input + input1;
            
            
            switch(result) {
            case "+" : System.out.printf("%d %s %d = %d",input,result,input1,Num1);break;
            case "-" : System.out.printf("%d %s %d = %d",
            		input,result,input1,input-input1);break;
            case "/" : 
            	if(input1 ==0) { System.out.println("0으로 나눌 수 없습니다.");}
            	else {
            		System.out.printf("%d %s %d = %.3f"
            				,input,result,input1,(double)input/input1);
            	}
            	break;
            case "*" : System.out.printf("%d %s %d = %d"
            		,input,result,input1,input * input1);break;
            case "%" : 
            	if(input1 ==0) { System.out.println("0으로 나눌 수 없습니다.");}
            	else {System.out.printf("%d %s %d =%d",input,result,input1,input%input1);
            	}break;
