...
public class APIView {
	...
	public void displayMenu() {
		...
		do {
			...
			System.out.println("---API TEST PROGRAM---");
			System.out.println("1. equlas() + hashCode() ");
			System.out.println("2. String Class 제공 메서드1(split)");
			System.out.println("3. String Class 제공 메서드1(join)");
			System.out.println("4. String Class의 특징 , 문제점 ");
	...
	private void ex1() {
		...
		// 한 학생의 정보를 입력 받아
		// Service의 학생 배열에 추가 (단, 죽복되는 학생은 제외)
		System.out.println("\n--- 학생 정보 입력 ---\n");
		...
		if (service.addStudent2(grade, classRoom, num, name)) {
