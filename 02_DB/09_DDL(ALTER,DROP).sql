...
ALTER TABLE DEPT_COPY ADD
CONSTRAINT CK_DEPT_COPY CHECK(LOCATION_ID IN ('L1','L2','L3','L4','L5'));
...
ALTER TABLE DEPT_COPY DROP CONSTRAINT SYS_C007538; -- NOT NULL
--NOT NULL 제약조건 ADD는 안되는데 DROP 은 가능


-- NOT NULL 제거 시 MODIFY 사용
ALTER TABLE DEPT_COPY
MODIFY DEPT_TITLE CONSTRAINT SYS_C007538 NULL;
...
SELECT * FROM DEPT_COPY;
-- DEPT_COPY 의 LNAME 컬럼의 모든 값을 기본값으로 수정
UPDATE DEPT_COPY
SET LNAME = DEFAULT;
