...
AND SUB.MANAGER_ID = MAIN.MANAGER_ID );
...
SELECT EMP_ID,EMP_NAME,NVL(DEPT_TITLE,"소속없음"),JOB_NAME,TO_CHAR(HIRE_DATE)
...
OR (ENT_YN = "N" AND MAIN.DEPT_CODE IS NULL

AND SUB.DEPT_CODE IS NULL))

ORDER BY HIRE_DATE;

-- 7. 직급별 나이가 가장 어린 직원의 (만 나이)
