...
public class ExceptionService {
	...
	public void ex2() {
		...
		try {
			...
			System.out.print("입력 : ");
			String input = br.readLine();
			// public String readLine() throws IOEception
	...
	public void ex3() {
		...
		try {
			...
			// 해결방법 : 상위 타입 catch 를 두쪽에 배치해서
			// 하위 타입 catch에 대한 검사가 먼저 진행되게 함

			// 스캐너 사용시 작성법이 잘못되거나 범위를 초과하면 발생하는 예외
			System.out.println("입력이 잘못되었습니다.");

		} finally { // finally : 마지막으로
	...
	public void ex4() {
		...
		// throws : 해당 메서드에서 발생한 예외를 호출한 메서드로 던져버리는 예외처리 방법
